...
{
  "gitBranch" : "master",
  "gitRepository" : "https://github.com/VikyaSurve/SimpleJavaWebApp",
  "liveUpdateIDESupport" : false,
  "projectName" : "SimpleJavaWebApp",
  "targetProject" : "SimpleJavaWebApp"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->SimpleJavaWebApp]
